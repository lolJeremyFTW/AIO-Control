...
function buildDashboardPublishPrompt(input: {
  ...
  return [
    ...
    "4. Controleer dat de tool-result een topic-tab URL teruggeeft onder `/n/.../tab/<slug>` en geen `/d/<slug>` URL.",
    ...
    "- Gebruik geen gevoelige secrets, tokens, privegegevens of ruwe persoonsgegevens. Dashboard-tabs zijn owner-only en horen binnen de business/topic-shell te blijven.",
