...
const nl: Dict = {
  ...
  "nav.workspaceAgents": "Workspace-agenten",
  "nav.workspaceFlows": "AI Flow Builder",
  "nav.queue": "Wachtrij",
  "nav.runs": "Runs",
  "nav.activity": "Activiteit",
  "nav.adminUsers": "Admin users",
  "nav.cost": "Kosten & verbruik",
  ...
  "page.workspaceAgents.countPlural": "agenten",
  ...
  "page.adminUsers.sub": "Alle gebruikers, werkspaces, logins en activiteit",
  "page.cost": "Kosten & verbruik",
  "page.cost.sub":
    "Verbruik per business · per agent · per provider — laatste 30 dagen",
  "page.marketplace": "Marketplace",
  "page.marketplace.sub": "Geselecteerde AI-agent-presets",

  "page.business.overview.sub": "Overzicht per business",
  "page.business.agents.title": "{business} — agenten",
  "page.business.agents.sub": "Providers · prompts · planningen",
  "page.business.schedules.title": "{business} — planningen",
  "page.business.schedules.sub": "Cron · webhooks · runhistorie",
  ...
  "page.business.runs.sub": "Volledige runhistorie van alle agenten",
  "page.business.subnav": "Sub-navigatie",

  "page.business.runs.h1": "{business} — runs",
  "page.business.agents.h1": "{business} — agenten",
  ...
  "wizard.step.mainAgent": "Hoofdagent",
  ...
  "agent.field.workspaceDefault": "— Workspace-standaard —",
  ...
  "agent.creds.subscription": "Claude Pro/Max/Team-abonnement",
  "agent.creds.subscription.desc":
    "Cron-runs draaien als Claude Routines op Claude's eigen infrastructuur. Geen API-key nodig. Quotum: 5/15/25 routine-runs per dag.",
  "agent.creds.apiKey": "Anthropic API-key (per token)",
  "agent.creds.apiKey.desc":
    "Cron-runs draaien lokaal via onze scheduler. Vereist een ANTHROPIC_API_KEY in je workspace-API-keys. Je betaalt per token, zonder routinequotum.",
  "agent.creds.env": "Env-var fallback",
  "agent.creds.env.desc":
    "Pakt ANTHROPIC_API_KEY uit de process-env als fallback. Handig voor solo development — niet aanbevolen voor multi-tenant.",
  "agent.routing.title": "Slimme routingregels (advanced)",
  "agent.routing.desc":
  ...
  "tg.topology.manual.desc":
    "Jij zet voor elke business / topic zelf welke chat_id + topic_id de rapporten moeten hebben.",
  "tg.topology.perBiz": "Auto-topic per business",
  "tg.topology.perBiz.desc":
    "Eén supergroep met topics. Iedere nieuwe business krijgt zijn eigen forumtopic.",
  ...
  "keys.scope.workspace": "Workspace-standaard",
  ...
  "keys.field.value": "Key (wordt versleuteld opgeslagen)",
  "keys.field.label": "Label (optioneel)",
  "keys.field.customSecret": "+ Eigen secret…",
  "keys.field.customName": "Secretnaam",
  "keys.field.customName.hint":
    "Alleen UPPERCASE A-Z, 0-9 en _ — bv. AIRTABLE_API_KEY. Wordt door agenten/modules opgevraagd via deze naam.",
  "keys.group.providers": "Providerkeys",
  "keys.group.custom": "Eigen secrets",

  "rail.empty": "Nog geen businesses",
  ...
  "topic.agents": "Agenten",
  "topic.schedules": "Planningen",
  "topic.integrations": "Integraties",

  "biztabs.overview": "Overzicht",
  "biztabs.agents": "Agenten",
  ...
  "dashboard.empty.body":
    "Hier verschijnen straks je geautomatiseerde mini-businesses. Maak er één aan om door te gaan.",
  "dashboard.queueEmpty.title": "Lege wachtrij ✓",
  "dashboard.queueEmpty.body":
    "Geen items te reviewen. Zodra een agent iets oppakt, verschijnt het hier — automatisch publiceren bij hoge confidence, anders HITL.",
  ...
  "biz.kpi.revenue30d": "OMZET 30D",
  "biz.kpi.cost30d": "AI KOSTEN 30D",
  "biz.kpi.revenue7d": "OMZET 7D",
  "biz.kpi.runs24h": "RUNS 24U",
  "biz.kpi.successFail": "GESLAAGD / MISLUKT",
  "biz.openQueue": "Open wachtrij",
  ...
  "biz.agentsCount": "Agenten · {count}",
  "biz.manage": "Beheer",
  "biz.noAgents.title": "Geen agenten",
  "biz.noAgents.body": "Voeg een agent toe om runs te starten.",
  "biz.recentRuns": "Recente runs",
  "biz.history": "Geschiedenis",
  ...
  "search.placeholder":
    "Zoek businesses, agenten, wachtrij-items, marketplace…",
  ...
  "search.tpl.workspaceAgents": "Workspace-agenten",
  "search.tpl.workspaceAgents.hint": "Alle agenten per business",
  "search.tpl.activity": "Activiteit",
  "search.tpl.activity.hint": "Audit log alle wijzigingen",
  "search.tpl.cost": "Kosten & verbruik",
  "search.tpl.cost.hint": "Per provider / business / agent",
  "search.tpl.marketplace": "Marketplace",
  "search.tpl.marketplace.hint": "Geselecteerde agent-presets",
  "search.tpl.profile": "Profiel",
  "search.tpl.profile.hint": "Account voorkeuren",
  "search.tpl.settingsTelegram": "Instellingen · Telegram",
  "search.tpl.settingsTelegram.hint": "Bot targets configureren",
  "search.tpl.settingsApiKeys": "Instellingen · API-keys",
  "search.tpl.settingsApiKeys.hint": "Providerkeys + overrides",
  "search.tpl.settingsSpendLimits": "Instellingen · Uitgavelimieten",
  "search.tpl.settingsSpendLimits.hint": "Dag-/maandlimieten",
  "search.tpl.settingsProviders": "Instellingen · Providers",
  "search.tpl.settingsProviders.hint": "Hermes/OpenClaw/Ollama setup",
  "search.tpl.bizAgents": "Deze business: agenten",
  "search.tpl.bizAgents.hint": "Agentenlijst per business",
  ...
  "ollama.btn.scan": "Modellen scannen",
  ...
  "providers.btn.test": "Verbinding testen",
  ...
  "providers.status.cliDefault": "CLI-standaard — geen URL nodig",

  "providers.ollama.tagline":
    "Lokale LLM. Gratis, snel als je een GPU hebt, geen API-keys.",
  "providers.ollama.modelsAvailable": "{count} modellen beschikbaar",
  ...
  "providers.ollama.step2":
    "Start Ollama. Standaard luistert hij op poort 11434.",
  "providers.ollama.step3":
    "Pull een model — bijvoorbeeld: ollama pull llama3.2",
  "providers.ollama.step4":
    "Vul host + poort in op de Ollama-instellingenpagina en klik op Scan.",

  "providers.hermes.tagline":
    "Self-hosted Hermes-runner. AIO Control praat met de hermes CLI via subprocess (standaard) of een HTTP-wrapper als je die zelf draait.",
  ...
  "providers.openclaw.tagline":
    "Lokale agent-runtime — eigen tools + eigen MCP. Draait als CLI-subprocess (standaard) of via HTTP-wrapper als je die zelf draait.",
  ...
  "providers.runtime.title": "Persistente runtime-agent",
  "providers.runtime.desc":
    "Maak één benoemd profiel of één benoemde agent in de runtime aan zodat sessies, geheugen en skills tussen runs blijven bestaan. AIO Control schakelt dan automatisch over naar deze named spawn in plaats van ad-hoc per beurt.",
  "providers.runtime.nameLabel": "Agentnaam",
  ...
  "topic.kpi.agents": "Agenten",
  "topic.kpi.activeRoutines": "Actieve routines",
  "topic.kpi.runs24h": "Runs 24u",
  "topic.kpi.successFail24h": "Geslaagd / mislukt 24u",
  "topic.kpi.cost30d": "Kosten 30d",
  "topic.openQueue": "Open wachtrij",
  ...
  "topic.history": "Geschiedenis",
  "topic.routines": "Routines",
  "topic.routines.manage": "Planningen beheren",
  "topic.routines.empty":
    "Nog geen routines voor dit topic. Ga naar Planningen om er één aan te maken en koppel die aan dit topic.",
  "topic.routines.on": "AAN",
  "topic.routines.off": "UIT",
  "topic.routines.neverFired": "—",

  "dash.kpi.agents": "Agenten",
  "dash.kpi.activeRoutines": "Actieve routines",
  "dash.kpi.runsToday": "Runs vandaag",
  "dash.kpi.cost30d": "Kosten 30d",
  "dash.kpi.revenue30d": "Omzet 30d",
  ...
  "dash.perBusiness.desc":
    "AI-kosten komen uit de runs-tabel. Omzet volgt zodra Stripe- of Mollie-hooks per business zijn aangesloten — de plekken zijn al gereserveerd.",
  "dash.perBusiness.empty": "Nog geen businesses in deze workspace.",
  "dash.perBusiness.revenue": "Omzet",
  ...
  "settings.section.agentDefaults": "Agentstandaarden",
  "settings.section.agentDefaults.desc":
    "Wat krijgt elke nieuwe agent als provider, model en systeemprompt? Per business of agent kun je dit nog overschrijven.",
  "settings.section.weather": "Weerchip",
  ...
  "settings.section.mcpTools.desc":
    "API-keys voor externe MCP-toolservers (Brave Search, Firecrawl). Sla op en test met één klik.",
  "settings.section.spendLimits": "Uitgavelimieten",
  ...
  "settings.section.email": "E-mailnotificaties",
  "settings.section.email.desc":
    "Run-rapporten via SMTP. Per-business / per-agent overrides via rechtsklik.",
  ...
  "settings.section.serverFiles.desc":
    "Alleen-lezen bladeren door bestanden op de server.",
  "settings.section.subscription": "Abonnement",
  "settings.field.workspaceName": "Workspacenaam",
  ...
  "schedules.title": "{business} — planningen",
  "schedules.section.new": "Nieuwe planning",
  "schedules.section.existing": "Bestaande planningen",
  ...
  "profile.section.account.desc": "E-mail + wachtwoord van je login.",
  "profile.section.contact": "Contact + facturatie",
  "profile.section.contact.desc":
    "Adres, telefoon, KvK-nummer en btw-id. Wordt gebruikt voor facturen en AVG-correspondentie. Alles is optioneel.",
  "profile.section.prefs": "Voorkeuren",
  "profile.section.prefs.desc": "Tijdzone + interfacetaal.",
  ...
  "profile.section.security": "Sessies / beveiliging",
...
const en: Partial<Dict> = {
  ...
  "page.adminUsers": "Admin users",
  "page.adminUsers.sub": "All users, workspaces, logins and activity",
  ...
  "page.business.schedules.h1": "{business} — routines",
  "page.business.integrations.h1": "{business} — integrations",
...
const de: Partial<Dict> = {
  ...
  "dashboard.queueEmpty.body":
    "Nichts zum Prüfen. Sobald ein Agent etwas übernimmt, erscheint es hier — automatische Veröffentlichung bei hoher Confidence, sonst HITL.",
  ...
  "biz.kpi.runs24h": "RUNS 24H",
  "biz.kpi.successFail": "ERFOLG / FEHLER",
  "biz.openQueue": "Offene Warteschlange",
  "biz.viewAll": "Alle ansehen",
  "biz.queueEmpty.title": "Warteschlange leer ✓",
  "biz.queueEmpty.body":
    "Nichts zu prüfen. Starte einen Run oder warte, bis ein Agent etwas übernimmt.",
  "biz.agentsCount": "Agenten · {count}",
  "biz.manage": "Verwalten",
  "biz.noAgents.title": "Keine Agenten",
  "biz.noAgents.body": "Füge einen Agenten hinzu, um Runs zu starten.",
  ...
  "search.placeholder":
    "Suche Businesses, Agenten, Warteschlangen-Items, Marketplace…",
  "search.scope.all": "Alle",
  "search.scope.business": "Dieses Business",
  "search.scope.global": "Workspace-weit",
  ...
  "search.tpl.workspaceAgents": "Workspace-Agenten",
  "search.tpl.workspaceAgents.hint": "Alle Agenten pro Business",
  ...
  "search.tpl.settingsTelegram": "Einstellungen · Telegram",
  "search.tpl.settingsTelegram.hint": "Bot-Ziele konfigurieren",
  "search.tpl.settingsApiKeys": "Einstellungen · API-Keys",
  "search.tpl.settingsApiKeys.hint": "Provider-Keys + Overrides",
  "search.tpl.settingsSpendLimits": "Einstellungen · Ausgabelimits",
  "search.tpl.settingsSpendLimits.hint": "Tages-/Monats-Caps",
  "search.tpl.settingsProviders": "Einstellungen · Providers",
  "search.tpl.settingsProviders.hint": "Hermes/OpenClaw/Ollama Setup",
  "search.tpl.bizAgents": "Dieses Business: Agenten",
  "search.tpl.bizAgents.hint": "Agentenliste pro Business",
  ...
  "providers.status.cliDefault": "CLI-Standard — keine URL nötig",

  "providers.ollama.tagline":
    "Lokales LLM. Kostenlos, schnell mit GPU, keine API-Keys.",
  ...
  "providers.hermes.tagline":
    "Self-hosted Hermes-Runner. AIO Control spricht mit der hermes CLI über einen Subprocess (Standard) oder einen HTTP-Wrapper.",
  "providers.hermes.step1":
  ...
  "providers.hermes.step4":
    "Optional: HTTP-Wrapper für Hermes? Füge die URL unten ein und klicke auf Test (erwartet /healthz → 200).",

  "providers.openclaw.tagline":
    "Lokale Agent-Runtime — eigene Tools + Custom MCP. Läuft als Subprocess oder über einen HTTP-Wrapper.",
  "providers.openclaw.step1":
  ...
  "providers.openclaw.step4":
    "Optional: openclaw als HTTP-Daemon? Füge die URL unten ein und klicke auf Test (erwartet /healthz).",

  "providers.runtime.title": "Persistenter Runtime-Agent",
  "providers.runtime.desc":
  ...
  "topic.kpi.runs24h": "Runs 24h",
  "topic.kpi.successFail24h": "Erfolg / Fehler 24h",
  ...
  "topic.history": "Verlauf",
  "topic.routines": "Routinen",
  "topic.routines.manage": "Zeitpläne verwalten",
  "topic.routines.empty":
    "Noch keine Routinen für dieses Topic. Erstelle eine in den Zeitplänen und binde sie an dieses Topic.",
  ...
  "nav.workspaceAgents": "Workspace-Agenten",
  "nav.workspaceFlows": "KI Flow Builder",
  "nav.queue": "Warteschlange",
  "nav.runs": "Runs",
  "nav.activity": "Aktivität",
  "nav.adminUsers": "Admin-User",
  ...
  "page.adminUsers": "Admin-User",
  "page.adminUsers.sub": "Alle User, Workspaces, Logins und Aktivität",
  ...
  "page.business.overview.sub": "Übersicht pro Business",
  "page.business.agents.title": "{business} — Agenten",
  "page.business.agents.sub": "Provider · Prompts · Zeitpläne",
  "page.business.schedules.title": "{business} — Zeitpläne",
  "page.business.schedules.sub": "Cron · Webhooks · Run-Verlauf",
  "page.business.integrations.title": "{business} — Integrationen",
  "page.business.integrations.sub":
    "Externe Services, die dieses Business nutzt",
  "page.business.runs.title": "{business} — Runs",
  "page.business.runs.sub": "Vollständiger Run-Verlauf aller Agenten",
  "page.business.subnav": "Subnavigation",

  "page.business.runs.h1": "{business} — Runs",
  "page.business.agents.h1": "{business} — Agenten",
  "page.business.schedules.h1": "{business} — Routinen",
  "page.business.integrations.h1": "{business} — Integrationen",

  "settings.sub": "Konto · Workspace · Automatisierungen",
  "settings.section.agentDefaults": "Agent-Standards",
  "settings.section.agentDefaults.desc":
    "Was bekommt jeder neue Agent als Provider, Modell und System-Prompt? Pro Business oder Agent kannst du es noch überschreiben.",
  ...
  "settings.section.mcpTools": "MCP Tools",
  "settings.section.mcpTools.desc":
    "API-Keys für externe MCP-Toolserver (Brave Search, Firecrawl). Mit einem Klick speichern und testen.",
  "settings.section.spendLimits": "Ausgabelimits",
  "settings.section.spendLimits.desc":
  ...
  "settings.section.serverFiles.desc":
    "Nur-Lese-Zugriff auf Dateien auf dem Server.",
  "settings.section.subscription": "Abonnement",
  "settings.field.workspaceName": "Workspace-Name",
  "settings.field.email": "E-Mail",
  ...
  "wizard.step.topics": "Topics",
  "wizard.step.mainAgent": "Hauptagent",
  "wizard.step.telegram": "Telegram",
  "wizard.step.isolation": "Isolation",
  ...
  "agent.dialog.workspaceGlobal":
    "Workspace-globaler Agent — nicht an ein Business gebunden. Aus dem Chat und als Schritt in Agent-Ketten workspace-weit verfügbar.",
  "agent.dialog.businessScoped":
  ...
  "agent.field.modelDefault": "Modell (Standard: {model})",
  "agent.field.endpoint": "Endpoint-URL (optional — Env-Standard, wenn leer)",
  "agent.field.systemPrompt": "System-Prompt (optional)",
  "agent.field.telegramTarget": "Telegram-Channel (optional)",
  ...
  "agent.kind.worker": "Worker (geplant / eventgesteuert)",
  "agent.kind.reviewer": "Reviewer (HITL-Gate)",
  "agent.kind.generator": "Generator (Content)",
  "agent.kind.router": "Router (Smart-Select)",
  "agent.creds.subscription": "Claude Pro/Max/Team-Abo",
  "agent.creds.subscription.desc":
    "Cron-Runs laufen als Claude Routines auf Claudes eigener Infrastruktur. Kein API-Key. Quota: 5/15/25 Routine-Runs pro Tag.",
  ...
  "agent.creds.env": "Env-Var Fallback",
  "agent.creds.env.desc":
    "Liest ANTHROPIC_API_KEY aus der Process-Env als Fallback. OK für Solo-Development, nicht für Multi-Tenant.",
  ...
  "tg.row.autoCreateLabel":
    "Forum-Topic pro neuem Business automatisch erstellen",
  "tg.field.name": "Name",
  "tg.field.scope": "Scope",
  "tg.field.scope.workspace": "Workspace-Default",
  "tg.field.scope.business": "Business",
  ...
  "keys.field.label": "Label (optional)",
  "keys.field.customSecret": "+ Eigenes Secret…",
  "keys.field.customName": "Secret-Name",
  "keys.field.customName.hint":
